...
npx agentdb@3.0.0-alpha.20 init ./vectors.db

# Custom dimensions for different embedding models
npx agentdb@3.0.0-alpha.20 init ./vectors.db --dimension 768  # sentence-transformers
npx agentdb@3.0.0-alpha.20 init ./vectors.db --dimension 384  # all-MiniLM-L6-v2

# Use preset configurations
npx agentdb@3.0.0-alpha.20 init ./vectors.db --preset small   # <10K vectors
npx agentdb@3.0.0-alpha.20 init ./vectors.db --preset medium  # 10K-100K vectors
npx agentdb@3.0.0-alpha.20 init ./vectors.db --preset large   # >100K vectors

# In-memory database for testing
npx agentdb@3.0.0-alpha.20 init ./vectors.db --in-memory
```
...
npx agentdb@3.0.0-alpha.20 query ./vectors.db "[0.1,0.2,0.3,...]"

# Top-k results
npx agentdb@3.0.0-alpha.20 query ./vectors.db "[0.1,0.2,0.3]" -k 10

# With similarity threshold (cosine similarity)
npx agentdb@3.0.0-alpha.20 query ./vectors.db "0.1 0.2 0.3" -t 0.75 -m cosine

# Different distance metrics
npx agentdb@3.0.0-alpha.20 query ./vectors.db "[...]" -m euclidean  # L2 distance
npx agentdb@3.0.0-alpha.20 query ./vectors.db "[...]" -m dot        # Dot product

# JSON output for automation
npx agentdb@3.0.0-alpha.20 query ./vectors.db "[...]" -f json -k 5

# Verbose output with distances
npx agentdb@3.0.0-alpha.20 query ./vectors.db "[...]" -v
```
...
npx agentdb@3.0.0-alpha.20 export ./vectors.db ./backup.json

# Import vectors from JSON
npx agentdb@3.0.0-alpha.20 import ./backup.json

# Get database statistics
npx agentdb@3.0.0-alpha.20 stats ./vectors.db
```
...
npx agentdb@3.0.0-alpha.20 query ./db.sqlite "[...]" -m cosine

# Euclidean distance (L2 norm)
npx agentdb@3.0.0-alpha.20 query ./db.sqlite "[...]" -m euclidean

# Dot product (for normalized vectors)
npx agentdb@3.0.0-alpha.20 query ./db.sqlite "[...]" -m dot
```
...
npx agentdb@3.0.0-alpha.20 query ./db.sqlite "[...]" -t 0.8  # Higher threshold
...
npx agentdb@3.0.0-alpha.20 init ./db.sqlite --dimension 768
```
...
- CLI Help: `npx agentdb@3.0.0-alpha.20 --help`
- Command Help: `npx agentdb@3.0.0-alpha.20 help <command>`
