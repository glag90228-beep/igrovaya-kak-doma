...
npx @claude-flow/cli@3.38.12 sparc run <mode> "task description"

# Use alpha features
npx claude-flow@3.38.12 sparc run <mode> "task description"

# List all available modes
npx @claude-flow/cli@3.38.12 sparc modes

# Get help for specific mode
npx @claude-flow/cli@3.38.12 sparc help <mode>

# Run with options
npx @claude-flow/cli@3.38.12 sparc run <mode> "task" --parallel --monitor

# Execute TDD workflow
npx @claude-flow/cli@3.38.12 sparc tdd "feature description"

# Batch execution
npx @claude-flow/cli@3.38.12 sparc batch <mode1,mode2,mode3> "task"

# Pipeline execution
npx @claude-flow/cli@3.38.12 sparc pipeline "task description"
```
...
```bash
# Before work
npx claude-flow@3.38.12 hooks pre-task --description "implement auth"

# During work
npx claude-flow@3.38.12 hooks post-edit --file "auth.js"

# After work
npx claude-flow@3.38.12 hooks post-task --task-id "task-123"
```
...
npx @claude-flow/cli@3.38.12 sparc run researcher "authentication patterns"

# Step 2: Architecture design
npx @claude-flow/cli@3.38.12 sparc run architect "design auth system"

# Step 3: TDD implementation
npx @claude-flow/cli@3.38.12 sparc tdd "user authentication feature"

# Step 4: Code review
npx @claude-flow/cli@3.38.12 sparc run reviewer "review auth implementation"

# Step 5: Documentation
npx @claude-flow/cli@3.38.12 sparc run documenter "document auth API"
```
...
npx @claude-flow/cli@3.38.12 sparc run analyzer "investigate bug #456"

# Step 2: Debug systematically
npx @claude-flow/cli@3.38.12 sparc run debugger "fix memory leak in service X"

# Step 3: Create tests
npx @claude-flow/cli@3.38.12 sparc run tester "regression tests for bug #456"

# Step 4: Review fix
npx @claude-flow/cli@3.38.12 sparc run reviewer "validate bug fix"
```
...
npx @claude-flow/cli@3.38.12 sparc run analyzer "profile API response times"

# Step 2: Identify bottlenecks
npx @claude-flow/cli@3.38.12 sparc run optimizer "optimize database queries"

# Step 3: Implement improvements
npx @claude-flow/cli@3.38.12 sparc run coder "implement caching layer"

# Step 4: Benchmark results
npx @claude-flow/cli@3.38.12 sparc run tester "performance benchmarks"
```
...
npx @claude-flow/cli@3.38.12 sparc pipeline "e-commerce checkout feature"
...
# Run specific mode
npx @claude-flow/cli@3.38.12 sparc run <mode> "task"

# TDD workflow
npx @claude-flow/cli@3.38.12 sparc tdd "feature"

# Full pipeline
npx @claude-flow/cli@3.38.12 sparc pipeline "task"

# Batch execution
npx @claude-flow/cli@3.38.12 sparc batch <modes> "task"
```
