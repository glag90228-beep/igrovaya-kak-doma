...
```bash
# CLI
npx agentdb@3.0.0-alpha.20 query ./vectors.db "[0.1,0.2,...]" -m cosine
...
```bash
# CLI
npx agentdb@3.0.0-alpha.20 query ./vectors.db "[0.1,0.2,...]" -m euclidean
...
```bash
# CLI
npx agentdb@3.0.0-alpha.20 query ./vectors.db "[0.1,0.2,...]" -m dot
...
npx agentdb@3.0.0-alpha.20 export ./vectors.db ./backup.json.gz --compress

# Import from backup
npx agentdb@3.0.0-alpha.20 import ./backup.json.gz --decompress

# Merge databases
npx agentdb@3.0.0-alpha.20 merge ./db1.sqlite ./db2.sqlite ./merged.sqlite
```
...
# Rebuild indices
npx agentdb@3.0.0-alpha.20 reindex ./vectors.db
```
