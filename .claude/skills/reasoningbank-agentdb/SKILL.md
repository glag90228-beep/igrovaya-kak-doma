...
npx agentdb@3.0.0-alpha.20 init ./.agentdb/reasoningbank.db --dimension 1536
...
# Verify migration
npx agentdb@3.0.0-alpha.20 stats ./.agentdb/reasoningbank.db
```
...
npx agentdb@3.0.0-alpha.20 export ./.agentdb/reasoningbank.db ./backup.json

# Import experiences
npx agentdb@3.0.0-alpha.20 import ./experiences.json
...
```bash
# Migrate from legacy ReasoningBank
npx agentdb@3.0.0-alpha.20 migrate --source .swarm/memory.db --target .agentdb/reasoningbank.db
...
DEBUG=agentdb:* npx agentdb@3.0.0-alpha.20 migrate --source .swarm/memory.db
```
