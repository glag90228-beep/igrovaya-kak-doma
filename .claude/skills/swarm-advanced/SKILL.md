...
claude mcp add claude-flow npx claude-flow@3.38.12 mcp start
```
...
npx @claude-flow/cli@3.38.12 swarm "research AI trends in 2025" \
  --strategy research \
  --mode distributed \
  --max-agents 6 \
  --parallel \
...
npx @claude-flow/cli@3.38.12 swarm "build REST API with authentication" \
...
```bash
# Quick testing swarm
npx @claude-flow/cli@3.38.12 swarm "test application comprehensively" \
  --strategy testing \
  --mode star \
  --parallel \
  --timeout 600
