...
```bash
npx @claude-flow/cli@3.38.12 agent logs <agent-id> [options]
```
...
```bash
# View last 50 lines
npx @claude-flow/cli@3.38.12 agent logs coder-lx7m9k2

# View last 100 lines
npx @claude-flow/cli@3.38.12 agent logs coder-lx7m9k2 -n 100

# Follow logs (live)
npx @claude-flow/cli@3.38.12 agent logs coder-lx7m9k2 --follow

# Filter by level
npx @claude-flow/cli@3.38.12 agent logs coder-lx7m9k2 -l error

# Logs since time
npx @claude-flow/cli@3.38.12 agent logs coder-lx7m9k2 --since "1h"
npx @claude-flow/cli@3.38.12 agent logs coder-lx7m9k2 --since "2026-01-08T10:00:00"

# JSON output
npx @claude-flow/cli@3.38.12 agent logs coder-lx7m9k2 --format json
```
...
# Last 30 minutes
npx @claude-flow/cli@3.38.12 agent logs coder-lx7m9k2 --since "30m"

# Specific timestamp
npx @claude-flow/cli@3.38.12 agent logs coder-lx7m9k2 --since "2026-01-08T09:00:00"

# Today's logs
npx @claude-flow/cli@3.38.12 agent logs coder-lx7m9k2 --since "today"
```
...
- `npx @claude-flow/cli@3.38.12 agent status` - Current agent status
- `npx @claude-flow/cli@3.38.12 agent health` - Health monitoring
- `npx @claude-flow/cli@3.38.12 agent metrics` - Performance metrics
