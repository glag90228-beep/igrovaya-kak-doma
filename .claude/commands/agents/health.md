...
```bash
npx @claude-flow/cli@3.38.12 agent health [agent-id] [options]
```
...
npx @claude-flow/cli@3.38.12 agent health

# Specific agent health
npx @claude-flow/cli@3.38.12 agent health coder-lx7m9k2

# Continuous monitoring
npx @claude-flow/cli@3.38.12 agent health --watch

# Custom interval
npx @claude-flow/cli@3.38.12 agent health -w -i 10

# JSON output
npx @claude-flow/cli@3.38.12 agent health --format json
```
...
- `npx @claude-flow/cli@3.38.12 agent status` - Detailed agent info
- `npx @claude-flow/cli@3.38.12 agent metrics` - Performance metrics
- `npx @claude-flow/cli@3.38.12 doctor` - System-wide health
