...
```bash
npx @claude-flow/cli@3.38.12 agent metrics [agent-id] [options]
```
...
npx @claude-flow/cli@3.38.12 agent metrics coder-lx7m9k2

# Last hour
npx @claude-flow/cli@3.38.12 agent metrics -p 1h

# Last 7 days
npx @claude-flow/cli@3.38.12 agent metrics --period 7d

# JSON output
npx @claude-flow/cli@3.38.12 agent metrics --format json
```
...
- `npx @claude-flow/cli@3.38.12 agent status` - Individual agent metrics
- `npx @claude-flow/cli@3.38.12 performance benchmark` - Full performance suite
- `npx @claude-flow/cli@3.38.12 status` - System-wide status
