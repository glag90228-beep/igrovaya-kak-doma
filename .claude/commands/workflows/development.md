...
npx @claude-flow/cli@3.38.12 workflow dev "REST API with auth"

# Create custom workflow
npx @claude-flow/cli@3.38.12 workflow create --name "api-dev" --steps "design,implement,test,deploy"

# Execute saved workflow
npx @claude-flow/cli@3.38.12 workflow execute api-dev
```