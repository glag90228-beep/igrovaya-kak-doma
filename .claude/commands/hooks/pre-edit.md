...
```bash
npx @claude-flow/cli@3.38.12 hook pre-edit -f "config/database.js" --validate-syntax
```

### Manual agent assignment

```bash
npx @claude-flow/cli@3.38.12 hook pre-edit -f "api/users.ts" --auto-assign-agent false
```
...
npx @claude-flow/cli@3.38.12 hook pre-edit --file "path/to/file.js" --validate-syntax
```
