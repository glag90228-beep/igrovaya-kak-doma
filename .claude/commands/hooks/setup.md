...
```bash
# Test pre-edit hook
npx @claude-flow/cli@3.38.12 hook pre-edit --file test.js

# Test session summary
npx @claude-flow/cli@3.38.12 hook session-end --summary
```
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [{
          "type": "command",
          "command": "npx @claude-flow/cli@3.38.12 hook pre-write --file '${tool.params.file_path}'"
        }]
      }
    ]
  }
...
# Test specific hook
npx @claude-flow/cli@3.38.12 hook pre-edit --file app.js --debug
```
