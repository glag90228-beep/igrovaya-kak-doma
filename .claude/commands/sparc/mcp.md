...
npx @claude-flow/cli@3.38.12 sparc run mcp "integrate with external API"

# For alpha features
npx claude-flow@3.38.12 sparc run mcp "integrate with external API"

# With namespace
npx @claude-flow/cli@3.38.12 sparc run mcp "your task" --namespace mcp

# Non-interactive mode
npx @claude-flow/cli@3.38.12 sparc run mcp "your task" --non-interactive
```
...
```bash
# Store mode-specific context
npx @claude-flow/cli@3.38.12 memory store "mcp_context" "important decisions" --namespace mcp

# Query previous work
npx @claude-flow/cli@3.38.12 memory query "mcp" --limit 5
```
