...
npx @claude-flow/cli@3.38.12 sparc run memory-manager "organize project knowledge"

# For alpha features
npx claude-flow@3.38.12 sparc run memory-manager "organize project knowledge"
```
