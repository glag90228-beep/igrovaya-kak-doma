...
npx @claude-flow/cli@3.38.12 sparc run swarm-coordinator "manage development swarm"

# For alpha features
npx claude-flow@3.38.12 sparc run swarm-coordinator "manage development swarm"
```
