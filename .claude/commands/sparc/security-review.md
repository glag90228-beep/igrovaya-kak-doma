...
npx @claude-flow/cli@3.38.12 sparc run security-review "audit API security"

# For alpha features
npx claude-flow@3.38.12 sparc run security-review "audit API security"

# With namespace
npx @claude-flow/cli@3.38.12 sparc run security-review "your task" --namespace security-review

# Non-interactive mode
npx @claude-flow/cli@3.38.12 sparc run security-review "your task" --non-interactive
```
...
```bash
# Store mode-specific context
npx @claude-flow/cli@3.38.12 memory store "security-review_context" "important decisions" --namespace security-review

# Query previous work
npx @claude-flow/cli@3.38.12 memory query "security-review" --limit 5
```
