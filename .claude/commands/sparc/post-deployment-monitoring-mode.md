...
npx @claude-flow/cli@3.38.12 sparc run post-deployment-monitoring-mode "monitor production metrics"

# For alpha features
npx claude-flow@3.38.12 sparc run post-deployment-monitoring-mode "monitor production metrics"

# With namespace
npx @claude-flow/cli@3.38.12 sparc run post-deployment-monitoring-mode "your task" --namespace post-deployment-monitoring-mode

# Non-interactive mode
npx @claude-flow/cli@3.38.12 sparc run post-deployment-monitoring-mode "your task" --non-interactive
```
...
```bash
# Store mode-specific context
npx @claude-flow/cli@3.38.12 memory store "post-deployment-monitoring-mode_context" "important decisions" --namespace post-deployment-monitoring-mode

# Query previous work
npx @claude-flow/cli@3.38.12 memory query "post-deployment-monitoring-mode" --limit 5
```
