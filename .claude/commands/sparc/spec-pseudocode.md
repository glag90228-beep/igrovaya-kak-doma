...
npx @claude-flow/cli@3.38.12 sparc run spec-pseudocode "define payment flow requirements"

# For alpha features
npx claude-flow@3.38.12 sparc run spec-pseudocode "define payment flow requirements"

# With namespace
npx @claude-flow/cli@3.38.12 sparc run spec-pseudocode "your task" --namespace spec-pseudocode

# Non-interactive mode
npx @claude-flow/cli@3.38.12 sparc run spec-pseudocode "your task" --non-interactive
```
...
```bash
# Store mode-specific context
npx @claude-flow/cli@3.38.12 memory store "spec-pseudocode_context" "important decisions" --namespace spec-pseudocode

# Query previous work
npx @claude-flow/cli@3.38.12 memory query "spec-pseudocode" --limit 5
```
