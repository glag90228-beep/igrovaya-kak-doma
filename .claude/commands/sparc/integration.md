...
npx @claude-flow/cli@3.38.12 sparc run integration "connect payment service"

# For alpha features
npx claude-flow@3.38.12 sparc run integration "connect payment service"

# With namespace
npx @claude-flow/cli@3.38.12 sparc run integration "your task" --namespace integration

# Non-interactive mode
npx @claude-flow/cli@3.38.12 sparc run integration "your task" --non-interactive
```
...
```bash
# Store mode-specific context
npx @claude-flow/cli@3.38.12 memory store "integration_context" "important decisions" --namespace integration

# Query previous work
npx @claude-flow/cli@3.38.12 memory query "integration" --limit 5
```
