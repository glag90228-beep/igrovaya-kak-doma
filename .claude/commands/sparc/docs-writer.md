...
npx @claude-flow/cli@3.38.12 sparc run docs-writer "create API documentation"

# For alpha features
npx claude-flow@3.38.12 sparc run docs-writer "create API documentation"

# With namespace
npx @claude-flow/cli@3.38.12 sparc run docs-writer "your task" --namespace docs-writer

# Non-interactive mode
npx @claude-flow/cli@3.38.12 sparc run docs-writer "your task" --non-interactive
```
...
```bash
# Store mode-specific context
npx @claude-flow/cli@3.38.12 memory store "docs-writer_context" "important decisions" --namespace docs-writer

# Query previous work
npx @claude-flow/cli@3.38.12 memory query "docs-writer" --limit 5
```
