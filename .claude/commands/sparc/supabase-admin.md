...
npx @claude-flow/cli@3.38.12 sparc run supabase-admin "create user authentication schema"

# For alpha features
npx claude-flow@3.38.12 sparc run supabase-admin "create user authentication schema"

# With namespace
npx @claude-flow/cli@3.38.12 sparc run supabase-admin "your task" --namespace supabase-admin

# Non-interactive mode
npx @claude-flow/cli@3.38.12 sparc run supabase-admin "your task" --non-interactive
```
...
```bash
# Store mode-specific context
npx @claude-flow/cli@3.38.12 memory store "supabase-admin_context" "important decisions" --namespace supabase-admin

# Query previous work
npx @claude-flow/cli@3.38.12 memory query "supabase-admin" --limit 5
```
