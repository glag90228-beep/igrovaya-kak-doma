...
npx @claude-flow/cli@3.38.12 sparc run debug "fix memory leak in service"

# For alpha features
npx claude-flow@3.38.12 sparc run debug "fix memory leak in service"

# With namespace
npx @claude-flow/cli@3.38.12 sparc run debug "your task" --namespace debug

# Non-interactive mode
npx @claude-flow/cli@3.38.12 sparc run debug "your task" --non-interactive
```
...
```bash
# Store mode-specific context
npx @claude-flow/cli@3.38.12 memory store "debug_context" "important decisions" --namespace debug

# Query previous work
npx @claude-flow/cli@3.38.12 memory query "debug" --limit 5
```
