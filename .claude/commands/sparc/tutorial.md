...
npx @claude-flow/cli@3.38.12 sparc run tutorial "guide me through SPARC methodology"

# For alpha features
npx claude-flow@3.38.12 sparc run tutorial "guide me through SPARC methodology"

# With namespace
npx @claude-flow/cli@3.38.12 sparc run tutorial "your task" --namespace tutorial

# Non-interactive mode
npx @claude-flow/cli@3.38.12 sparc run tutorial "your task" --non-interactive
```
...
```bash
# Store mode-specific context
npx @claude-flow/cli@3.38.12 memory store "tutorial_context" "important decisions" --namespace tutorial

# Query previous work
npx @claude-flow/cli@3.38.12 memory query "tutorial" --limit 5
```
