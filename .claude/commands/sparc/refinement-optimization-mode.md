...
npx @claude-flow/cli@3.38.12 sparc run refinement-optimization-mode "optimize database queries"

# For alpha features
npx claude-flow@3.38.12 sparc run refinement-optimization-mode "optimize database queries"

# With namespace
npx @claude-flow/cli@3.38.12 sparc run refinement-optimization-mode "your task" --namespace refinement-optimization-mode

# Non-interactive mode
npx @claude-flow/cli@3.38.12 sparc run refinement-optimization-mode "your task" --non-interactive
```
...
```bash
# Store mode-specific context
npx @claude-flow/cli@3.38.12 memory store "refinement-optimization-mode_context" "important decisions" --namespace refinement-optimization-mode

# Query previous work
npx @claude-flow/cli@3.38.12 memory query "refinement-optimization-mode" --limit 5
```
