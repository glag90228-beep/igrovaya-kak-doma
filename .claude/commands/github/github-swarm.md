...
```bash
npx @claude-flow/cli@3.38.12 github swarm [options]
```
...
```bash
npx @claude-flow/cli@3.38.12 github swarm --repository owner/repo
```

### Maintenance-focused swarm

```bash
npx @claude-flow/cli@3.38.12 github swarm -r owner/repo -f maintenance --issue-labels
```

### Development swarm with PR automation

```bash
npx @claude-flow/cli@3.38.12 github swarm -r owner/repo -f development --auto-pr --code-review
```

### Full-featured triage swarm

```bash
npx @claude-flow/cli@3.38.12 github swarm -r owner/repo -a 8 -f triage --issue-labels --auto-pr
```
