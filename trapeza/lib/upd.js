  ...
  const sfHead = status === 1 ? `
    <table class="sf">
      ...
      ${/*
         ...
         *
         * Своего учёта авансовых счетов-фактур у нас нет, поэтому значение
         * приходит извне (doc.advDoc). Строку печатаем всегда: её отсутствие
         * в бланке — несоответствие форме, а пустая строка формой прямо
         * предусмотрена.
         */''}
