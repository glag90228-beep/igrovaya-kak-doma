...
const DOC_KINDS = [
  ...
  // «чек» — через edge, а не \b: в JS граница слова определена по латинице,
  // и \bчек\b не совпадает никогда. Ровно эта ловушка в проекте уже ловилась.
  [/квитанц/iu, 'Квитанция'],
  [edge('чек(?:а|и|у|е|ов|ам|ами)?|check|receipt'), 'Квитанция'],
];
