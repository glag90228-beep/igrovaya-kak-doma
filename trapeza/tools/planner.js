...
const TASKS = [
  ...
  ['Организации', 'Нумерация документов — по организации, а не по человеку',
    ...
    'system-architect', 'lib/bot-db.js', 6, '', 'Ждёт'],
  ['Организации', 'Перенос уже выписанного: проставить org_id',
    'В боевой базе документы лежат с org_id организации по умолчанию — миграция должна быть обратимой',
    'coder', 'lib/bot-db.js', 4, 'Нумерация по организации', 'Ждёт'],
  ['Организации', 'Сальдо по паре «организация — контрагент»',
    ...
    'system-architect', 'lib/bot-db.js, db.js', 8, 'Нумерация по организации', 'Ждёт'],
