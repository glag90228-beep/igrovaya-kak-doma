...
Всего к оплате: 6 250,00`;
  ...
  console.log('\n── авансы, корректировки, книга продаж ──');
  {
     ...
     * Но строка 5а уходит в книгу продаж (графа 11а), и повтор закрывал бы
     ...
     * Открытых авансов у него нет вовсе, значит и строки 5а быть не должно.
     */
    ...
    ok(!pRep.advDoc, 'повторный УПД вышел без чужой строки 5а', pRep.advDoc);
