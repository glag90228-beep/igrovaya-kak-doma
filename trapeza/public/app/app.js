    ...
    box.append(h('div', { class: 'card' },
      h('div', { class: 'row' },
        ...
        h('span', { class: 'grow' },
          ...
          // «Сверху ноль» годится, только когда там действительно ноль. Раньше
          // подсказку и показывали лишь в этом случае — оттого и формулировка
          // была одна. Теперь она приходит и когда долг есть, просто не тот.
          h('div', { class: 'small muted', text: (m.zero === false
