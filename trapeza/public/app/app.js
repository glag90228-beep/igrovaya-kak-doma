...
screens.vat = async function vat() {
  ...
  box.append(h('div', { class: 'card' },
    opt('Без НДС', 'упрощёнка до порога, патент, самозанятость', cur === null, () => pick(null, false)),
    ...
    opt('20% сверху', 'переходный период / старые договоры', cur === '20' && !gross, () => pick(20, false)),
    opt('20% в том числе', 'цены уже с налогом 20%', cur === '20' && gross, () => pick(20, true)),
    ...
    opt('5% УСН', 'пониженная для упрощёнки', cur === '5', () => pick(5, false)),
    opt('7% УСН', 'пониженная для упрощёнки', cur === '7', () => pick(7, false)),
